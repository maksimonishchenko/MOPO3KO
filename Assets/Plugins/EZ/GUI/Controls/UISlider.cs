...
public class UISlider : AutoSpriteControlBase
{
	...
	public override void Start()
	{
		...
		if(Application.isPlaying)
		{
			...
			knob.SetMaxScroll(height*0.75f );
		...
		for (int i = 0; i < knobLayers.Length; ++i)
		{
			knobLayers[i].transform.renderer.enabled = true;
		}
	}
	...
	protected Vector3 CalcKnobStartPos()
	{
		...
		switch(anchor)
		{
			case ANCHOR_METHOD.TEXTURE_OFFSET:
				...
				pos.y = (height * +0.5f -100f) + stopKnobFromEdge;
				break;
	...
	{
		knobLayers[0].transform.renderer.enabled = true;
		return knob;
	}
