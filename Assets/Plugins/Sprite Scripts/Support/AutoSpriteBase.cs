...
public class TextureAnim
{
	...
	public float pauseBetweenCycles = 0;
...
[System.Serializable]
public class DrivenAnimation {
	public int driverAnimID;
	public int actionFrame;
	public int animID;
	public MonoBehaviour monoBeh;
	public string msg_name;
	public AudioSource audio;
	[HideInInspector]
	public bool soundPlayed = false;
	public bool playOnce = false;
	public SpriteBase[] playSprites;
	public PackedSprite[] hideSprites;
	public PackedSprite[] revertSprites;
	public int spriteBaseStartPlayingFrame =0;
	public PackedSprite[] blockedSprites;
	public PackedSprite[] unblockedSprites;
	public PackedSprite[] busyFalseActionFire;
	public PackedSprite[] playInReverseSprites;
...
public abstract class AutoSpriteBase : SpriteBase, ISpriteAggregator, ISpriteAnimatable
{
	...
	public DrivenAnimation[] drivenAnims=null;
	private System.Action<AutoSpriteBase> frameDelegateAction = delegate {
	...
	public override bool StepAnim(float time)
	{
		...
		if (curAnim.curPauseTime >0)
		{
			curAnim.curPauseTime-=time;
			framesToAdvance=0;
			return true;
		} else if (curAnim.curPauseTime < 0)
		{
			curAnim.curPauseTime=0;
		...
		int numLoops = curAnim.numLoops;
		
		while (framesToAdvance > 0)
		{
			if (curAnim.GetNextFrame(ref frameInfo))
			{
				if (numLoops != curAnim.numLoops && curAnim.pauseBetweenCycles != 0)
				{
					//Animation loop occured
					curAnim.curPauseTime=curAnim.pauseBetweenCycles;
					framesToAdvance=0;
					timeSinceLastFrame=0;
					RevertToStaticDontStop();
				}
	...
	/// <summary>
	/// Reverts the sprite to its static (non-animating) default appearance dont stoping StepAnim calls.
	/// </summary>
	public void RevertToStaticDontStop()
	{
		// Reset the animation:
		if (curAnim != null)
			curAnim.Reset();
	...
	public void AddAutoSpriteBaseFrameAction(System.Action<AutoSpriteBase> autoSpriteBaseFrameAction)
	{
		frameDelegateAction+=autoSpriteBaseFrameAction;
	}
	
	public void RemoveAutoSpriteBaseFrameAction(System.Action<AutoSpriteBase> autoSpriteBaseFrameAction)
	{
		frameDelegateAction-=autoSpriteBaseFrameAction;	
	}
	
	public DrivenAnimation[] GetDrivenAnimations()
	{
		DrivenAnimation[] anims = null;
		...
		// Called every frame
	public void frameDelegate() 
	{
		frameDelegateAction(this);
	}
}